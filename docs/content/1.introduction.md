...
You can now enable **content editing directly in production**, with real-time preview and Git integration (GitHub, GitLab, Azure DevOps), all from within your own Nuxt application.
